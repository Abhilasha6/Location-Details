...
async function initMap() {
  ...
  map = new Map(mapElement, {
    ...
    center: userLocation,
      ...
      () => {
        handleLocationError(true, mapElement);
      }
    );
  } else {
    // Browser doesn't support Geolocation
    handleLocationError(false, mapElement);
  }
}

function handleLocationError(browserHasGeolocation, mapElement) {
  mapElement.innerHTML = browserHasGeolocation
...
function plotElevationChart(elevationData) {
  ...
  function drawChart() {
    ...
    var options = {
        title: "Car Route Elevation Chart",
        hAxis: { title: "Distance from start location" },
        vAxis: { title: "Elevation in meters" },
